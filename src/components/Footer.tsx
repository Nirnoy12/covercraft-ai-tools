        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-foreground/70">
              Creating professional resumes and cover letters with AI-powered technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a href="#features" className="text-sm text-foreground/70 hover:text-primary">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-sm text-foreground/70 hover:text-primary">
                  Pricing
                </a>
              </li>
              <li>
